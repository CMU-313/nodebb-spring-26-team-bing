		...
		describe('Local categories', () => {
			...
			describe('new reply', () => {
				...
				before(async () => {
					...
					const { pid } = await api.topics.reply(
						{ uid },
						{
							tid,
							content: utils.generateUUID(),
		...
		describe('Remote Categories', () => {
			...
			describe('replies', () => {
				it('should federate out a Create activity with the remote community addressed', async () => {
					...
					const postData = await api.topics.reply(
						{ uid },
						{
							tid,
							content: utils.generateUUID(),
		...
		describe('Announce', () => {
			...
			describe('(Create)', () => {
				it('should create a new topic in a remote category if addressed', async () => {
					...
					({ activity } = helpers.mocks.announce({
						actor: remoteCid,
						object: activity,
					}));
