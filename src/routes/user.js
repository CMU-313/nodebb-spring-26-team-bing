...
module.exports = function (app, name, middleware, controllers) {
	...
	setupPageRoute(
		app,
		`/${name}/:userslug/shares`,
		middlewares,
		controllers.accounts.posts.getShares,
	);
	setupPageRoute(
		app,
	...
	setupPageRoute(
		...
		`/${name}/:userslug/read`,
		accountMiddlewares,
		controllers.accounts.posts.getReadTopics,
	);
	setupPageRoute(
		app,
	...
	setupPageRoute(
		app,
		`/${name}/:userslug/chats/:roomid?/:index?`,
		[middleware.exposeUid, middleware.canViewUsers],
	...
	setupPageRoute(
		...
		`/message/:mid`,
		[middleware.ensureLoggedIn],
		controllers.accounts.chats.redirectToMessage,
	);
};
