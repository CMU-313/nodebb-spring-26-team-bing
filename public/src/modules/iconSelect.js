...
define("iconSelect", ["benchpress", "bootbox"], function (Benchpress, bootbox) {
	...
	const initialIcons = [
		...
		{
			id: "rectangle-xmark",
			label: "Rectangle X Mark (solid)",
			style: "solid",
		},
		{
			id: "triangle-exclamation",
			label: "Triangle exclamation (solid)",
			style: "solid",
		},
		...
		{ id: "square-caret-up", label: "Square caret up (solid)", style: "solid" },
		{
			...
			label: "Square caret right (solid)",
			style: "solid",
		},
		{
			id: "square-caret-left",
			label: "Square caret left (solid)",
			style: "solid",
		},
		{
			id: "square-caret-down",
			label: "Square caret down (solid)",
			style: "solid",
		},
		...
		{
			id: "temperature-half",
			label: "Temperature half (solid)",
			style: "solid",
		},
		{
			id: "temperature-quarter",
			label: "Temperature quarter (solid)",
			style: "solid",
		},
		{
			id: "temperature-empty",
			label: "Temperature empty (solid)",
			style: "solid",
		},
		...
		{ id: "gauge-high", label: "Gauge (solid)", style: "solid" },
		{
			...
			label: "Tablet screen button (solid)",
			style: "solid",
		},
		...
		{ id: "hands", label: "Hands (solid)", style: "solid" },
		{
			...
			label: "Right from bracket (solid)",
			style: "solid",
		},
		{
			id: "right-to-bracket",
			label: "Right to bracket (solid)",
			style: "solid",
		},
		{
			id: "share-from-square",
			label: "Share from square (solid)",
			style: "solid",
		},
		...
		{ id: "bath", label: "Bath (solid)", style: "solid" },
		{
			...
			label: "Arrow Rotate Right (solid)",
			style: "solid",
		},
		{
			id: "arrow-rotate-left",
			label: "Arrow Rotate Left (solid)",
			style: "solid",
		},
		...
		{ id: "money-bill-1", label: "Money bill 1 (solid)", style: "solid" },
		{
			...
			label: "Mobile screen button (solid)",
			style: "solid",
		},
		...
		{ id: "share", label: "Share (solid)", style: "solid" },
		{
			...
			label: "Wand magic sparkles (solid)",
			style: "solid",
		},
		...
		{
			id: "building-columns",
			label: "Building with Columns (solid)",
			style: "solid",
		},
		...
		{
			id: "hand-point-right",
			label: "Hand Pointing Right (solid)",
			style: "solid",
		},
		{
			id: "hand-point-left",
			label: "Hand Pointing Left (solid)",
			style: "solid",
		},
		{
			id: "hand-point-down",
			label: "Hand Pointing Down (solid)",
			style: "solid",
		},
		...
		{ id: "square-up-right", label: "Square up right (solid)", style: "solid" },
		{
			...
			label: "Up right from square (solid)",
			style: "solid",
		},
		{
		...
		{ id: "battery-full", label: "Battery Full (solid)", style: "solid" },
		{
			...
			label: "Battery 3/4 Full (solid)",
			style: "solid",
		},
		{ id: "battery-half", label: "Battery 1/2 Full (solid)", style: "solid" },
		{
			id: "battery-quarter",
			label: "Battery 1/4 Full (solid)",
			style: "solid",
		},
		...
		{ id: "maximize", label: "Maximize (solid)", style: "solid" },
		{
			...
			label: "Up down left right (solid)",
			style: "solid",
		},
	...
	iconSelect.init = function (el, onModified) {
		...
		Benchpress.render("partials/fontawesome", { icons: initialIcons }).then(
			function (html) {
				html = $(html);
				...
				picker.on("shown.bs.modal", function () {
					...
					modalEl.find(".icon-container").on("click", "i", function () {
						searchEl.val(
							cleanFAClass($(this)[0].classList).icon.replace("fa-", ""),
						);
	...
	const excludedClassRegex = RegExp(
		`\\bfa-(${excludedClassList.join("|")})\\b`,
		"i",
	);
