	...
	function updateDropdowns(modified_cids, state) {
		modified_cids.forEach(function (cid) {
			...
			category
				...
				.toggleClass("hidden", state !== "watching");
			category
				.find('[component="category/watching/check"]')
				.toggleClass("fa-check", state === "watching");

			category
				.find('[component="category/tracking/menu"]')
				.toggleClass("hidden", state !== "tracking");
			category
				.find('[component="category/tracking/check"]')
				.toggleClass("fa-check", state === "tracking");

			category
				.find('[component="category/notwatching/menu"]')
				.toggleClass("hidden", state !== "notwatching");
			category
				.find('[component="category/notwatching/check"]')
				.toggleClass("fa-check", state === "notwatching");

			category
				.find('[component="category/ignoring/menu"]')
				.toggleClass("hidden", state !== "ignoring");
			category
				.find('[component="category/ignoring/check"]')
				.toggleClass("fa-check", state === "ignoring");
		});
	}
